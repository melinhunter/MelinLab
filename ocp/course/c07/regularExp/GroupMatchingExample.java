...
public class GroupMatchingExample {
	public static void main(String[] args) {
		...
		if (m1.find()) {
			...
			System.out.println("p1 group2: " + m1.group(2));
			System.out.println("p1 group3: " + m1.group(3));
		...
		if (m2.find()) {
			System.out.println("p2 group1: " + m2.group(1));
			System.out.println("p2 group2: " + m2.group(2));
			System.out.println("p2 group3: " + m2.group(3));
